      ...
      <div className="flex items-start justify-between gap-3 mb-3">
        <div>
          <div className="flex items-center gap-2">
            <h4 className="text-sm font-bold text-[#17201A]">{title}</h4>
            {required ? (
            ...
            {isHighlighted && (
              <span className="text-[11px] font-extrabold text-orange-800 bg-orange-200 px-2 py-0.5 rounded-full animate-pulse">
                Update Requested
              </span>
            )}
          </div>
  ...
  return (
    <div className="bg-white rounded-3xl p-6 sm:p-10 border border-[#E2E8E3] shadow-xs space-y-8 animate-in fade-in duration-200">
      ...
      <div className="space-y-2">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
          ...
          <button
            ...
            className="text-xs font-semibold text-emerald-700 bg-emerald-50 hover:bg-emerald-100 px-3 py-1.5 rounded-lg border border-emerald-200 self-start sm:self-auto flex items-center gap-1.5 cursor-pointer transition-colors"
          >
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="p-4 rounded-2xl bg-[#F0FDF4] border border-emerald-200 flex items-start gap-3 text-[#166534]">
          <Lock className="w-4 h-4 shrink-0 mt-0.5 text-[#166534]" />
