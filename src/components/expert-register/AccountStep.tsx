          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-10 py-3 rounded-xl border text-sm text-[#17201A] placeholder-slate-400 bg-[#F7F9F4] focus:bg-white focus:outline-none transition-all ${
