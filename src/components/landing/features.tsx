...
export function Features() {
  ...
  return (
    <section id="features" className="py-12 sm:py-16 lg:py-20 bg-[#F4F4F6]">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 sm:gap-4">
              {problems.map((prob, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className="p-4 sm:p-5 rounded-[22px] sm:rounded-[24px] border border-[rgba(234,234,236,0.85)] bg-white shadow-[0_4px_20px_-2px_rgba(0,0,0,0.04),0_2px_6px_-1px_rgba(0,0,0,0.02)] hover:shadow-[0_8px_30px_-4px_rgba(0,0,0,0.07)] transition-shadow space-y-2.5"
                  >
          ...
          <div className="lg:col-span-6">
            <div className="relative rounded-[24px] sm:rounded-[28px] overflow-hidden shadow-[0_10px_40px_-8px_rgba(0,0,0,0.12)] border border-[rgba(234,234,236,0.85)] aspect-[4/3] sm:aspect-[16/11]">
              <Image
              ...
              />
              <div className="absolute bottom-3 left-3 right-3 sm:left-auto sm:bottom-6 sm:right-6 sm:max-w-xs bg-[#0F9F68]/95 backdrop-blur-md text-white p-3.5 sm:p-4 rounded-[18px] sm:rounded-[20px] shadow-xl flex items-center gap-3">
