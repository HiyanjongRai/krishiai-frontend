...
export function CTA() {
  ...
  return (
    <section className="py-16 bg-gradient-to-br from-[#0F9F68] via-[#0D8A5A] to-[#0A6B45] text-white text-center relative overflow-hidden">
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 space-y-6 relative z-10">
        ...
        <div className="pt-2 flex justify-center gap-4">
          <button
            ...
            className="px-6 py-3.5 text-sm font-bold text-[#0F9F68] bg-white hover:bg-[#F4F4F6] rounded-full transition-all shadow-[0_4px_20px_rgba(0,0,0,0.15)] flex items-center gap-2 cursor-pointer"
          >
